    ...
    $scope.addManipulation = function(edit_val) {  // Takes care of address add and edit ie Address Manipulator
      ...
      var addressPopup = $ionicPopup.show({
        template: '<input type="text"   placeholder="Nick Name"  ng-model="data.nickname"> <br/> ' +
                  '<input type="text"   placeholder="Endereço" ng-model="data.address"> <br/> ' +
                  '<input type="number" placeholder="Pincode" ng-model="data.pin"> <br/> ' +
                  '<input type="number" placeholder="Celular" ng-model="data.phone">',
        title: title,
        subTitle: sub_title,
        scope: $scope,
        buttons: [
...
// TESTE HOME
.controller('MainHome', function($scope, $state, $ionicSlideBoxDelegate){
...
.controller('checkoutCtrl', function($scope,$rootScope,sharedUtils,$state,$firebaseArray,
    ...
    $scope.pay=function(address,payment){
      ...
      if(address==null || payment==null){
        ...
        sharedUtils.showAlert("Erro","Por gentileza escolha um endereço e um Modo de Pagamento.")
      }
      else {
        ...
        sharedUtils.showAlert("Parabéns", "Pedido Realizado com Sucesso!");
    ...
    $scope.addManipulation = function(edit_val) {  // Takes care of address add and edit ie Address Manipulator
      ...
      if(edit_val!=null) {
        ...
        $scope.data = {};    // For adding new address
        var title="Adicione seu endereço";
        var sub_title="Adicione um novo novo endereço";
      }
      // An elaborate, custom popup
      var addressPopup = $ionicPopup.show({
        template: '<input type="text"   placeholder="Nick Name"  ng-model="data.nickname"> <br/> ' +
        '<input type="text"   placeholder="Endereço" ng-model="data.address"> <br/> ' +
        '<input type="number" placeholder="CEP" ng-model="data.pin"> <br/> ' +
        '<input type="number" placeholder="Celular" ng-model="data.phone">',
        title: title,
        subTitle: sub_title,
        scope: $scope,
