...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://menudapizza-afc63.firebaseio.com/"),
    refCart = new Firebase("https://menudapizza-afc63.firebaseio.com/cart"),
    refUser = new Firebase("https://menudapizza-afc63.firebaseio.com/users"),
    refCategory = new Firebase("https://menudapizza-afc63.firebaseio.com/category"),
    refOrder = new Firebase("https://menudapizza-afc63.firebaseio.com/orders"),
    refFeatured = new Firebase("https://menudapizza-afc63.firebaseio.com/featured"),
    refMenu = new Firebase("https://menudapizza-afc63.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
...
.factory('sharedUtils',['$ionicLoading','$ionicPopup', function($ionicLoading,$ionicPopup){
    ...
    functionObj.showLoading=function(){
      $ionicLoading.show({
        content: '<ion-spinner icon="spiral"></ion-spinner> ', // The text to display in the loading indicator
